<?php
/* Smarty version 3.1.30, created on 2016-12-16 00:38:46
  from "D:\PHP\studyPHP\MyDimension\views\template\admin\category\add.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5852c716b903d1_25707609',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd8b7c7a856d85c90b4aeac2810357802c898bbb8' => 
    array (
      0 => 'D:\\PHP\\studyPHP\\MyDimension\\views\\template\\admin\\category\\add.html',
      1 => 1481819904,
      2 => 'file',
    ),
  ),
...
function content_5852c716b903d1_25707609 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
?>
		...
		<form role="form" action="index.php?p=admin&c=category&a=save" method="post">
			<div class="row row-offcanvas row-offcanvas-right">
            	...
            	<button type="button" class="btn btn-primary btn-xs" data-toggle="offcanvas">Toggle nav</button>
				  	...
				  	<!-- Default panel contents -->
				  		<div class="panel-heading">当前操作：添加栏目</a></div>
				  		<!-- form -->
							<div class="form-group" style="margin-top:3%;">
								<label for="inputCateName">栏目名称：</label>
								<input type="text" name="name" class="form-control" id="inputCateName" placeholder="请输入栏目名称">
							</div>
